...
public class ControladorUsuarioTest {
	...
	private ControladorUsuario controladorUsuario = new ControladorUsuario(servicioUsuariosMock, servicioCiudadMock,
			servicioProvinciaMock, servicioDireccionMock);
	...
	@Test
	public void queCuandoSeRegistreUnUsuarioLoRetorneALaVistaFormularioUsuario() {
	...
	@Test
	public void queCuandoSeCreeUnNuevoUsuarioRetorneALaVistaRegistracionExitosa()
	...
	@Test
	public void queCuandoElUsuarioIngreseUnaPasswordVaciaRetorneLaVistaErrores()
			throws PasswordVaciaException, UsuarioYaExisteException, DireccionNoValidaException {
	...
	@Test
	public void queSiElUsuarioYaEstaRegistradoRetorneALaVistaErrores()
			throws PasswordVaciaException, UsuarioYaExisteException, DireccionNoValidaException {
	...
	@Test
	public void queSiElUsuarioIngresaUnaDireccionNoValidaRetorneALaVistaErrores()
			throws PasswordVaciaException, UsuarioYaExisteException, DireccionNoValidaException {
	...
	@Test
	public void queCuandoElUsuarioQuieraVerSusInmueblesAlquiladosSinTenerAlgunoLoRetorneALaVistaMisInmueblesAlquiladosConMensajeDeError() {
	...
	public void queCuandoElUsuarioQuieraVerLosTorneosALosQueParticipaLoRetorneALaVistaMisTorneosParticipo() {
		...
		// preparacion
		when(servicioUsuariosMock.listarTorneosQueParticipaUnUsuario(USUARIO_ID))
				.thenReturn(torneosQueParticipaElUsuario);
	...
	public void queCuandoElUsuarioQuieraVerLosTorneosALosQueParticipaSinParticiparEnAlgunoLoRetorneALaVistaMisInmueblesAlquiladosConMensajeDeError() {
		...
		when(servicioUsuariosMock.listarTorneosQueParticipaUnUsuario(USUARIO_ID))
				.thenReturn(torneosEnLosQueParticipaUnUsuario);
